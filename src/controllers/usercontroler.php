        ...
        public function insertCliente($elementos,$nome,$sobrenome,$endereco,$numero,$shipping,$subtotal,$total){
            ...
            if(isset($this->action)){
                ...
                $this->analise=$cliente->Create_cliente($this->elementos,$this->nome,$this->sobrenome,$this->endereco,$this->numero,$this->shipping,$this->subtotal,$this->total,$this->inputdata);

                if(!isset($this->nome,$this->numero,$this->endereco,$this->elementos)){
                ...
                $_SESSION['auth']='ok';
                header('Location:../index.php?page=messages/checkdone');
                exit;

                }else{

                $_SESSION['auth']='ok';
                header('Location:../index.php?page=messages/checkcap');
