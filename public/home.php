...
<input class="flex-1 bg-transparent border-b border-white/20 px-4 py-4 focus:border-primary focus:ring-0 text-sm outline-none transition-colors text-white placeholder-slate-600" placeholder="Endereço de Email" name ="email" type="email" required/>
